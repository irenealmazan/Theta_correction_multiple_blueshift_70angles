...
figure(4); imagesc(im_phase_quality,[minp maxp]), colormap(gray), axis square, axis off; title('Phase quality map'); 
...
%figure(4); imagesc(im_mag), colormap(gray), axis square, axis off; title('Magnitude image'); 
%figure(5); imagesc(im_phase), colormap(gray), axis square, axis off; title('Wrapped phase'); 
figure(8); imagesc(im_unwrapped), colormap(jet), axis square, axis off; title('Unwrapped phase'); 
